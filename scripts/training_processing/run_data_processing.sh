...
# ============================================================================
# Pipeline di processing dataset per honeypot Gemma-3 LoRA
# ============================================================================
...
echo "🚀 Honeypot Dataset Processing Pipeline"
echo "========================================"
...
# ============================================================================
echo "📌 STEP 1/8: Splitting dataset..."
...
if [ -f "${PROJECT_ROOT}/split.py" ]; then
  ...
  echo "⚠️  split.py not found. Assuming split_train.json and split_val.json exist."
fi
...
# ============================================================================
echo ""
echo "📌 STEP 2/8: Converting to JSONL format..."
...
# ============================================================================
echo ""
echo "📌 STEP 3/8: Formatting prompt/completion..."
...
# ============================================================================
echo ""
echo "📌 STEP 4/8: Sanitizing base64 payloads..."
...
# ============================================================================
echo ""
echo "📌 STEP 5/8: Sanitizing hex sequences..."
...
# ============================================================================
echo ""
echo "📌 STEP 6/8: Collapsing hex token runs..."
...
# ============================================================================
echo ""
echo "📌 STEP 7/8: Transforming to final chat format..."
...
# ============================================================================
echo ""
echo "📌 STEP 8/8: Cleaning up intermediate files..."
