...
2. `process_sessions.py`: Reads the output of the parser and reconstructs the longest unique sequence for every session ID. It adds an <EOS> (End of Sentence) token.
