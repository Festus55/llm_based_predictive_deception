...
class CowrieSSHFactory(factory.SSHFactory):
    ...
    #%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    # sessioni attive contemporaneamente: max 1 alla volta
    active_sessions = 0 
    #%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    def buildProtocol(self, addr):
        ...
        if CowrieSSHFactory.active_sessions >= 1:
            log.msg(f"Connection rejected from {addr}.")
            return None # immediate connection drop
        #%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    
        ...
        #%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        # Already checked session limit of 1. 
        CowrieSSHFactory.active_sessions += 1
        log.msg(f"Session started. Active sessions: {CowrieSSHFactory.active_sessions}")

        # We wrap the transport's connectionLost method to catch when they leave.
        original_connectionLost = t.connectionLost

        def connectionLost_wrapper(reason):
            # Decrement the counter
            CowrieSSHFactory.active_sessions -= 1
            if CowrieSSHFactory.active_sessions < 0:
                CowrieSSHFactory.active_sessions = 0 # Safety net for errors
            
            log.msg(f"Session ended. Active sessions: {CowrieSSHFactory.active_sessions}")
            
            # Proper cleanup by Cowrie
            return original_connectionLost(reason)

        # Apply the wrapper to this specific connection instance
        t.connectionLost = connectionLost_wrapper
        #%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
